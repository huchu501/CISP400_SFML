...
void Pickup::setArena(IntRect arena)
{
	...
	// 50 pixels inside the boundary so that it doesn't spawn on walls
...
int Pickup::gotIt()
{
	// After picking up, de-spawn the upgrade and
	// set the spawn timer to 0 so that I'll spawn again later
	m_Spawned = false;
